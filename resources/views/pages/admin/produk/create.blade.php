                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="link" name="link" class="form-control" placeholder="Shopee Link (Ex: https://www.shopee.co.id)" value="{{ old('link') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="tiktok_link" name="tiktok_link" class="form-control" placeholder="Tiktok Link (Ex: https://www.tiktok.com)" value="{{ old('tiktok_link') }}" required>
                                </div>
                            </div>
